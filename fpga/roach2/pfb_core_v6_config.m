...
function pfb_core_v6_config(this_block)

  % Revision History:
  %
  %   06-Sep-2014  (14:21 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/domagalski/wrk/pocket_corr/pfb_core_v6.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('pfb_core_v6');
  ...
  pol1_out1_port.setType('UFix_36_0');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol1_in1').width ~= 16);
      this_block.setError('Input data type for port "pol1_in1" must have width=16.');
    end
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('pfb_core_v6.vhd');
