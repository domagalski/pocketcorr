...
function fft_core_v6_config(this_block)

  % Revision History:
  %
  %   06-Sep-2014  (14:21 hours):
  %     Original code was machine generated by Xilinx's System Generator after parsing
  %     /home/domagalski/wrk/pocket_corr/fft_core_v6.vhd
  %
  %

  this_block.setTopLevelLanguage('VHDL');

  this_block.setEntityName('fft_core_v6');
  ...
  %    this_block.addFile('');
  %    this_block.addFile('');
  this_block.addFile('fft_core_v6.vhd');
