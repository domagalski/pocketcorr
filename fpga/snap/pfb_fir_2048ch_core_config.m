...
function pfb_fir_2048ch_core_config(this_block)
  ...
  this_block.addSimulinkInport('pol2_in0');
  this_block.addSimulinkInport('pol2_in1');
  this_block.addSimulinkInport('pol3_in0');
  this_block.addSimulinkInport('pol3_in1');
  ...
  this_block.addSimulinkOutport('pol2_out0');
  this_block.addSimulinkOutport('pol2_out1');
  this_block.addSimulinkOutport('pol3_out0');
  this_block.addSimulinkOutport('pol3_out1');
  ...
  pol2_out0_port = this_block.port('pol2_out0');
  pol2_out0_port.setType('Fix_18_17');
  pol2_out1_port = this_block.port('pol2_out1');
  pol2_out1_port.setType('Fix_18_17');
  pol3_out0_port = this_block.port('pol3_out0');
  pol3_out0_port.setType('Fix_18_17');
  pol3_out1_port = this_block.port('pol3_out1');
  ...
  if (this_block.inputTypesKnown)
    ...
    if (this_block.port('pol2_in0').width ~= 8);
      this_block.setError('Input data type for port "pol2_in0" must have width=8.');
    end

    if (this_block.port('pol2_in1').width ~= 8);
      this_block.setError('Input data type for port "pol2_in1" must have width=8.');
    end

    if (this_block.port('pol3_in0').width ~= 8);
      this_block.setError('Input data type for port "pol3_in0" must have width=8.');
    end

    if (this_block.port('pol3_in1').width ~= 8);
