...
function fft_2048ch_6a_core_config(this_block)
  ...
  this_block.addSimulinkInport('pol4_in0');
  this_block.addSimulinkInport('pol4_in1');
  this_block.addSimulinkInport('pol5_in0');
  this_block.addSimulinkInport('pol5_in1');
